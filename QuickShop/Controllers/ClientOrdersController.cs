...
namespace QuickShop.Controllers
{
    ...
    public class ClientOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageIndex)
        {
            ...
            IQueryable<Order> query = context.Orders.Include(o => o.OrderItems).OrderByDescending(o => o.Id).Where(o=>o.ClientId == currentUser.Id);
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var order = context.Orders.Include(o => o.OrderItems)
                .ThenInclude(oi => oi.Product).Where(p => p.ClientId == currentUser.Id)
